...
export default function Swap() {
  ...
  // console.log('wrapType：', wrapType, WrapType.NOT_APPLICABLE)
      ...
      <AppBody>
        ...
        <Wrapper id="swap-page">
          ...
          <AutoColumn gap={'md'} style={{ position: 'relative' }}>
            <CurrencyInputPanel
              label={independentField === Field.OUTPUT && !showWrap && trade ? 'Token From (estimated)' : 'Token From'}
            ...
            <AutoColumn
              ...
              style={{ position: 'absolute', top: '82px', left: '50%', transform: 'translateX(-50%)', zIndex: 2 }}
            >
            ...
            <CurrencyInputPanel
              ...
              label={independentField === Field.INPUT && !showWrap && trade ? 'Token To (estimated)' : 'Token To'}
              showMaxButton={false}
          ...
          <BottomGrouping>
            {!account ? (
              ...
              <ButtonPrimary disabled={Boolean(wrapInputError)} onClick={onWrap}>
                ...
                {wrapInputError ??
                  (wrapType === WrapType.WRAP ? t('Swap') : wrapType === WrapType.UNWRAP ? t('Swap') : null)}
              </ButtonPrimary>
            ) : noRoute && userHasSpecifiedInputOutput ? (
              <GreyCard style={{ textAlign: 'center', fontFamily: 'OrbitronBold' }}>
