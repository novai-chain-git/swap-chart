...
import { useOpenMetamask } from '../../state/application/hooks'
...
export default function AddLiquidity({
  ...
  const openMetamask = useOpenMetamask() // toggle wallet when disconnected
    ...
    return noLiquidity ? (
      ...
      <AutoColumn gap="20px">
        ...
        <TYPE.italic fontSize={12} textAlign="left" padding={'8px 0 0 0 '}>
          {t('Output is estimated Tip', { allowedSlippage: allowedSlippage / 100 })}
        </TYPE.italic>
      </AutoColumn>
    )
  }
              ...
              <>
                <GreyCard padding="0px" borderRadius={'20px'}>
                  <RowBetween
                    ...
                    height={'80px'}
                    borderRadius="20px"
                    style={{ background: theme.bgto1, color: theme.text7, alignItems: 'flex-start' }}
                  >
                    <TYPE.subHeader fontWeight={500} fontSize={14} fontFamily={'OrbitronMedium'}>
      ...
      {pair && !noLiquidity && pairState !== PairState.INVALID ? (
        <AutoColumn
          style={{
            ...
            maxWidth: '420px',
            marginTop: '1rem',
            background: theme.bgto1,
            padding: '1px',
            borderRadius: '16px'
          }}
        >
          <MinimalPositionCard showUnwrapped={oneCurrencyIsWETH} pair={pair} background={theme.bg7} />
        </AutoColumn>
      ) : null}
    </>
  )
